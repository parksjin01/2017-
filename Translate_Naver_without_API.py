...
res = translate('''Jae-gyun Hwang did not realize his dream of making the major leagues when spring training ended. But he did not end his dream, either.
...
“The velocity is a little higher on average,” Hwang said. “But the more comfortable I get in the batter’s box and the more pitches I see, the more my timing is getting up to speed. So the more opportunities I get, I’ll be able to hit the ball pretty comfortably from now on.”''')
for i in res:
    print i